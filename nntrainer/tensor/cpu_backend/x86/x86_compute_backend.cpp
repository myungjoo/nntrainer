...
#endif
  return 0.0f; // Fallback for sdot if BLAS is not available
}
...
#endif
  return 0.0f; // Fallback for snrm2 if BLAS is not available
}
...
#endif
  return 0; // Fallback for isamax if BLAS is not available
}
